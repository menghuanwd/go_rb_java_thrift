...
type RpcService interface {
	// Parameters:
	//  - Name
	GetName(name string) (r string, err error)
}
...
// Parameters:
//  - Name
func (p *RpcServiceClient) GetName(name string) (r string, err error) {
	if err = p.sendGetName(name); err != nil {
		return
	}
	return p.recvGetName()
}

func (p *RpcServiceClient) sendGetName(name string) (err error) {
...
func (p *RpcServiceClient) recvGetName() (value string, err error) {
...
func NewRpcServiceProcessor(handler RpcService) *RpcServiceProcessor {
	...
	self4.processorMap["GetName"] = &rpcServiceProcessorGetName{handler: handler}
	return self4
}
...
type rpcServiceProcessorGetName struct {
	handler RpcService
}

func (p *rpcServiceProcessorGetName) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := NewGetNameArgs()
	...
	if result.Success, err = p.handler.GetName(args.Name); err != nil {
...
func (p *GetNameArgs) readField1(iprot thrift.TProtocol) error {
...
func (p *GetNameArgs) writeField1(oprot thrift.TProtocol) (err error) {
